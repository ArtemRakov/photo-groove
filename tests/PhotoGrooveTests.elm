...
import PhotoGroove exposing (Model, Msg(..), Status(..), Photo, initialModel, update, urlPrefix, view)
...
urlFuzzer =
    Fuzz.intRange 1 5
        |> Fuzz.map urlFromCount

urlFromCount : Int -> List String
urlFromCount urlCount = List.range 1 urlCount
